                ...
                <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div className="navbar-nav">
                        ...
                        <div className="dropend">
                            <button className="btn border-0" id="link" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <IoGlobeOutline className="fs-4" />
                            </button>
                            <ul className="dropdown-menu dropdown-menu-start">
                                <li><button className="dropdown-item text-center fw-medium" onClick={() => changeLanguage('en')}><img src="https://flagcdn.com/us.svg" alt="Hebrew" width="24" height="16" /> {t('english')}</button></li>
                                <li><button className="dropdown-item text-center fw-medium" onClick={() => changeLanguage('he')}><img src="https://flagcdn.com/il.svg" alt="Hebrew" width="24" height="16" /> {t('hebrew')}</button></li>
                            </ul>
                        </div>
                            ...
                            <>
                                <div className="btn-group d-none d-lg-inline">
                                    ...
                                    <ul className="dropdown-menu dropdown-menu-end">
                                        ...
                                        <li><button className="dropdown-item text-center fw-medium" onClick={handleLogout}>{t('logout')}</button></li>
                                    </ul>
                                </div>
                                <div className="d-lg-none navbar-nav align-items-center">
                                    ...
                                    <button className="nav-link fw-medium" id="link" onClick={handleLogout}>{t('logout')}</button>
                                </div>
                            </>
                            :
                            <>
                                <NavLink className="nav-link text-center fw-medium" id="link" to="/login">{t('login')}</NavLink>
                                <NavLink className="nav-link text-center fw-medium" id="link" to="/register">{t('signup')}</NavLink>
                            </>
                        }
                    </div>
                </div>
